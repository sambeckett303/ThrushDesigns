  ...
  methods:
  {
	...
	template:
        '<div>' 
          ...
          +			      '<div class="imageContainer" :style="{height: imageContainerHeight}"><img :src="image.url"></div>'
          +           '<p style="position: absolute; text-align: center;" :style="{top: imageContainerHeight }" v-html="image.description"></p>'
          +         '</div>'
          +		   '</template>'
          +		'</transition-group>'
